...
@include('oss_ga_stats::views.time._header', ['page' => 'hour'])
        ...
        <div class="panel-collapse collapse in">
            ...
            <div class="panel-body">
                ...
                <div class="pull-right">
                    <button type="button" class="btn btn-link btn-download" data-url="{{ route('oss_ga_stats::download.hour') }}">다운로드</button>
                </div>
