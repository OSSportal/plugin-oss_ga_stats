...
@include('oss_ga_stats::views.traffic._header', ['page' => 'source'])

<div class="panel-group" role="tablist" aria-multiselectable="true">
    <div class="panel">
        <div class="panel-heading">
            <div class="pull-left">
                <h3 class="panel-title">유입 경로</h3>
            </div>
        </div>
        <div class="panel-collapse collapse in">
            ...
            <div class="panel-body">
                ...
                <div class="pull-right">
                    <button type="button" class="btn btn-link btn-download" data-url="{{ route('oss_ga_stats::download.source') }}">다운로드</button>
                </div>
